...
#     browser = browser_setup
#     registration_page.open_login_page(browser)
#
...
def test_search_ui(browser_setup):
    browser1 = browser_setup
    registration_page1 = RegistrationPage(browser1)

    registration_page1.open_login_page(browser1)
    registration_page1.set_login()
    registration_page1.set_password()
    registration_page1.login_attempt()
    user_main_page.should_have_welcome_and_user_name()
...
#
#     registration_page.open_user_main_page_and_set_cookies(browser, authorization_response.cookies)
#     user_main_page.should_have_welcome_and_user_name()
